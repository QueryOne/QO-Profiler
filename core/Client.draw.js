Client = (function(Client) {
  ...
  let drawPanel = function() {
    ...
    let d  = '<div id="subpanel-1" onclick="Core.tryConnect(\'\')"><div class="subpanel-display">C</div></div>'
        d += '<div id="subpanel-2"><div class="subpanel-display">&lfloor;&rceil;</div></div>'
        // &laquo;&raquo; &lfloor;&rceil;
        d += '<div id="subpanel-3"><div class="subpanel-display">{}</div></div>'
        d += '<div id="subpanel-4"><div class="subpanel-display">P</div></div>'
        d += '<div id="subpanel-5"><div class="subpanel-display">?</div></div>'
