...
Coding.unlockKey = async function() {
  ...
  if (f) {
    ...
    $key.val('').val(f)
    Coding.info('Successfully decrypted locally encrypted Github token.')
    // console.log('Successfully unlocked token: ' + f)
    return
  } else {
    $pwd.val('').addClass('error').attr('placeholder','wrong password')
    Coding.info('Failed attempt to decrypt locally encrypted Github token.')
    return
  }  
}
...
Coding.upload = function() {
  ...
  Coding.info('Attempting system upload to Github.')
  ...
  p = p.then(function() { 
    ...
    console.log(e)
    Coding.info('System upload to Github successful.')
...
Coding.download = function() {
  ...
  Coding.info('Attempting system download from Github.')
  ...
  p = p.then(function() { 
    ...
    console.log(e)
    Coding.info('System download from Github, successful.')
    if (e.content) {
