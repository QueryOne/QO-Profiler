...
Preloader = (function() {
  let list = [
   ...
   // Coding
   './core/Coding.jQuery.extension.js',
   './core/Coding.tree.jQuery.js',
   './core/Coding.sample.js',
   './core/Coding.main.js',
   './core/Coding.ui.js',
   // Coding, repository
   './core/Utilities.PBKDF2.js',
   './core/Utilities.gzip.js',
   './core/Coding.remote.js',
   
   // Profiler
   './core/Profiler.main.js',
   './core/Profiler.ui.js',

   './core/GMCPHandler.js', // game-specific, developer to implement

   // remove on deployment
   // '../.audiometry/audiometry.js',
   // '../.ambience/ambience.js',
  ]
  let cssList = [
   'core/rules.Main.css',
   ...
   // Coding
   'core/Coding.css',
   'core/Coding.tree.jQuery.extends.css',
   'core/Coding.tree.jQuery.css',
   
   // Profiler
   'core/Profiler.titular.css',
  ]
